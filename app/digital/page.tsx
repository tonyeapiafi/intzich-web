  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="absolute rounded-full pointer-events-none" style={{ width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(20,144,104,0.07) 0%, transparent 70%)', top: '-150px', right: '-100px', filter: 'blur(80px)', animation: 'orb-drift-2 15s ease-in-out infinite' }} />
        <div className="absolute inset-0 dot-grid pointer-events-none" style={{ opacity: 0.5 }} />
        <div className="max-w-[1200px] mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium mb-6" style={{ border: '1px solid rgba(29,158,117,0.3)', background: 'rgba(20,144,104,0.06)', color: '#149068' }}>
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#149068', boxShadow: '0 0 6px #24C28F' }} />
            Intzich Digital
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a href="#services" className="inline-block px-7 py-3.5 rounded-xl text-base font-semibold no-underline" style={{ border: '1px solid rgba(255,255,255,0.1)', color: '#7B79A0' }}>
              See Our Services
            </a>
          </div>
        </div>
      ...
      {/* WHAT WE BUILD */}
      <section id="services" className="py-24 px-6" style={{ background: '#F6F5FF' }}>
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal className="text-center mb-14">
            <p className="text-sm font-medium uppercase tracking-widest mb-3" style={{ color: '#149068' }}>Capabilities</p>
            <h2 className="font-display font-bold text-3xl sm:text-4xl" style={{ color: '#0D0B26' }}>What we build</h2>
          </ScrollReveal>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-5">
            {[
              ...
              <ScrollReveal key={title} delay={i * 80}>
                <div className="light-card light-card-teal p-6 h-full">
                  <div className="text-3xl mb-4">{icon}</div>
                  <h3 className="font-display font-semibold text-sm mb-2" style={{ color: '#0D0B26' }}>{title}</h3>
      ...
      <section className="py-24 px-6" style={{ background: '#FFFFFF' }}>
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal className="text-center mb-14">
            <p className="text-sm font-medium uppercase tracking-widest mb-3" style={{ color: '#149068' }}>Why Us</p>
            <h2 className="font-display font-bold text-3xl sm:text-4xl" style={{ color: '#0D0B26' }}>The Intzich Digital difference</h2>
          </ScrollReveal>
          <ScrollReveal>
            <div className="light-card overflow-hidden">
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ background: 'rgba(20,144,104,0.06)', borderBottom: '1px solid rgba(83,74,183,0.1)' }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={label as string} style={{ borderBottom: '1px solid rgba(83,74,183,0.06)', background: i % 2 === 0 ? 'transparent' : 'rgba(83,74,183,0.02)' }}>
                      <td className="p-4 font-medium" style={{ color: '#0D0B26' }}>{label}</td>
                      <td className="p-4 text-center" style={{ color: '#7B79A0' }}>{them}</td>
                      <td className="p-4 text-center font-medium" style={{ color: '#149068' }}>{us}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      {/* DIGITAL LAUNCHPAD */}
      <section id="digital-launchpad" className="py-24 px-6" style={{ background: '#F6F5FF' }}>
        <div className="max-w-[1200px] mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <ScrollReveal>
              <div className="inline-block px-2.5 py-1 rounded-md text-xs font-semibold mb-5" style={{ background: 'rgba(29,158,117,0.1)', color: '#149068' }}>
                Digital · Project
              </div>
              <h2 className="font-display font-bold text-3xl sm:text-4xl mb-2" style={{ color: '#0D0B26' }}>Digital Launchpad</h2>
              ...
              <p className="text-sm mb-6" style={{ color: '#7B79A0' }}>Timeline: 3–4 weeks · Ideal for trades and SMBs</p>
              <p className="leading-relaxed mb-8" style={{ color: '#7B79A0' }}>
            ...
            <ScrollReveal delay={150}>
              <div className="light-card light-card-teal p-8">
                <h3 className="text-xs font-semibold uppercase tracking-widest mb-5" style={{ color: '#7B79A0' }}>What&apos;s included</h3>
        ...
        <div className="max-w-[680px] mx-auto text-center">
          <ScrollReveal>
            <div className="rounded-2xl p-10" style={{ background: 'rgba(186,117,23,0.06)', border: '1px solid rgba(186,117,23,0.2)' }}>
              <h2 className="font-display font-bold text-2xl mb-3" style={{ color: '#0D0B26' }}>Not sure where to start?</h2>
              <p className="mb-6" style={{ color: '#7B79A0' }}>
