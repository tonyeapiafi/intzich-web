  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="absolute rounded-full pointer-events-none" style={{ width: '500px', height: '500px', background: 'radial-gradient(circle, rgba(83,74,183,0.08) 0%, transparent 70%)', top: '-100px', right: '10%', filter: 'blur(80px)', animation: 'orb-drift-1 14s ease-in-out infinite' }} />
        ...
        <div className="max-w-[1200px] mx-auto relative z-10 max-w-[760px]">
          <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-6xl leading-[1.05] mb-6" style={{ color: '#0D0B26' }}>
            Built by someone who{' '}
            <span className="gradient-text">understands your world.</span>
          </h1>
          <p className="text-lg leading-relaxed max-w-[560px]" style={{ color: '#7B79A0' }}>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid md:grid-cols-3 gap-12 items-start">
            <ScrollReveal className="flex flex-col items-center text-center">
              ...
              <h2 className="font-display font-bold text-xl mb-1" style={{ color: '#0D0B26' }}>Tonye Apiafi, PMP</h2>
              <p className="text-sm mb-1" style={{ color: '#7B79A0' }}>Founder, Intzich</p>
              <p className="text-xs" style={{ color: '#7B79A0' }}>Project Manager & Operational Strategy Leader, Lloyd HVAC Services</p>
            </ScrollReveal>

            <div className="md:col-span-2 flex flex-col gap-5">
              <ScrollReveal>
                <p className="leading-relaxed" style={{ color: '#7B79A0' }}>
      ...
      {/* CREDENTIALS */}
      <section className="py-12 px-6" style={{ background: '#FFFFFF', borderTop: '1px solid rgba(83,74,183,0.06)', borderBottom: '1px solid rgba(83,74,183,0.06)' }}>
        <div className="max-w-[1200px] mx-auto">
            ...
            {[
              ...
              <ScrollReveal key={badge} delay={i * 80}>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xs font-bold flex-shrink-0 font-display" style={{ background: 'rgba(83,74,183,0.08)', border: '1px solid rgba(83,74,183,0.2)', color: '#534AB7' }}>
                    {badge}
                  </div>
                  <p className="text-sm font-medium" style={{ color: '#7B79A0' }}>{label}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      {/* MISSION QUOTE */}
      <section className="py-20 px-6 relative overflow-hidden" style={{ background: '#F6F5FF' }}>
        ...
        <div className="max-w-[720px] mx-auto text-center relative z-10">
          <ScrollReveal>
            ...
            <p className="font-display font-bold text-2xl sm:text-3xl leading-snug mb-6" style={{ color: '#0D0B26' }}>
      ...
      <section className="py-24 px-6" style={{ background: '#FFFFFF' }}>
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal className="text-center mb-14">
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl" style={{ color: '#0D0B26' }}>Our ventures</h2>
          </ScrollReveal>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: 'Intzich Advisory', color: '#534AB7', bg: 'rgba(83,74,183,0.08)', border: 'rgba(83,74,183,0.2)', desc: 'Organizational strategy and business management consulting for SMBs, trades, and professional services firms across Ontario.', link: '/advisory', linkLabel: 'Learn more →', external: false },
              { name: 'Intzich Digital', color: '#149068', bg: 'rgba(20,144,104,0.06)', border: 'rgba(29,158,117,0.2)', desc: 'AI-assisted websites, digital marketing, and workflow automation built for growing businesses.', link: '/digital', linkLabel: 'Learn more →', external: false },
              ...
              <ScrollReveal key={name} delay={i * 100}>
                <div className="rounded-2xl p-7 h-full flex flex-col" style={{ background: bg, border: `1px solid ${border}` }}>
                  ...
                  <p className="text-sm leading-relaxed flex-1 mb-5" style={{ color: '#7B79A0' }}>{desc}</p>
                  {external ? (
      ...
      {/* LIGHT UP */}
      <section className="py-12 px-6" style={{ background: '#F6F5FF' }}>
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal>
            <div className="rounded-2xl p-8" style={{ background: 'rgba(83,74,183,0.04)', border: '1px solid rgba(83,74,183,0.08)' }}>
              <h3 className="font-display font-semibold text-lg mb-3" style={{ color: '#0D0B26' }}>Light Up Campaigns</h3>
